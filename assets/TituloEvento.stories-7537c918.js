/* empty css              */import{T as s}from"./TituloEvento-6d6faf8d.js";import"./vue.esm-bundler-fc91e5f6.js";import"./_plugin-vue_export-helper-c27b6911.js";const l={title:"Devix/Eventos/Atomos/TituloEvento",component:s,argTypes:{}},n="titulo",i=a=>({components:{TituloEvento:s},setup(){return{args:a}},template:'<TituloEvento v-bind="args"  />'}),t=i.bind({});t.args={titulo:n};var o,e,r;t.parameters={...t.parameters,docs:{...(o=t.parameters)==null?void 0:o.docs,source:{originalSource:`args => ({
  components: {
    TituloEvento
  },
  setup() {
